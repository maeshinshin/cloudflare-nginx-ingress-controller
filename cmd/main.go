...
func main() {
	...
	var nginxIngressServiceNamespace string
	...
	flag.StringVar(&nginxIngressServiceNamespace, "nginx-ingress-service-namespace", "ingress-nginx",
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2efed943.my.domain",
	...
	if err = (&controller.IngressReconciler{
		...
		NginxIngressServiceNamespace:     nginxIngressServiceNamespace,
